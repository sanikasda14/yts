                    ...
                    <div className="">
                        <div>
                            ...
                            <div className="flex items-center gap-4 mt-4">
                                <div>
                                    <p className="mt-2 text-sm text-justify">Our legacy of facilitating pilgrims in performing their obligatory religious Hajj duty, goes back to over two decades, when the visionary late Haji Bashir Bhai Chokhawala laid the foundation of yourtravelshop.com in partnership with Haji Yusuf Bhai Kherada of Al Khalid Tours, Mumbai in 1995.</p>
                                    
                                    <p className="mt-2 text-sm text-justify">Since our inception, every year we have enabled hundreds of pilgrims to successfully fulfil their promise to Allah SWT. Our expert team of experienced professionals in England, India and Saudi Arabia are committed towards ensuring that every aspect of this holy spiritual pilgrimage is executed flawlessly, and the pilgrim is in a relaxed state of mind during the sacred journey.</p>
                                    
                                    <p className="mt-2 text-sm text-justify">We pride ourselves in providing excellent service, focusing on ensuring your absolute comfort delivered with love, sincerity and empathy. We are recognised, respected and held in high esteem by both pilgrims across many Countries worldwide, and our fellow colleagues & peers in the Hajj & Umrah Industry.</p>
                                </div>
                            </div>
                        </div>
                    </div>
